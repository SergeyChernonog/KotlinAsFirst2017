...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("0 апреля 2011"))
        assertEquals("", dateStrToDigit("1 апреля 0"))
        assertEquals("", dateStrToDigit("01 апреля 20 19"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("курица курица 22.5"))
